...
public class MyContentProvider extends ContentProvider {
    ...
    static final String DATABASE_NAME = "MyUserDB";
    ...
    static final String PROVIDER_NAME = "com.example.contentproviderdemo.provider";
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            case uriCode:
                return "com.example.contentproviderdemo.provider/users";
            default:
